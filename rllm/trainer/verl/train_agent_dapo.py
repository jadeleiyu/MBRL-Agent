...
"""
Entry point to run agent training with DAPO-style filtering on top of verl.
This mirrors train_agent_ppo but uses AgentDAPOTrainer.
"""
...
from rllm.trainer.verl.agent_dapo_trainer import AgentDAPOTrainer
...
@hydra.main(config_path="../config", config_name="agent_dapo_trainer", version_base=None)
def main(config):
    run_dapo_agent(config)


def run_dapo_agent(config):
