...
ENV_CLASSES = {
    ...
    "world_model_web": safe_import("rllm.environments.web_world.world_model_env", "WorldModelWebEnv"),
}
...
AGENT_CLASSES = {
    ...
    "world_model_web_agent": safe_import("rllm.agents.world_model_web_agent", "WorldModelWebAgent"),
}
